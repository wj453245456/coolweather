...
public class AutoUpdateService extends Service {
    ...
    private  void updateWeather(){
        ...
        if (weatherString != null){
            ...
            String weatherUrl = "http://guolin.tech/api/weather>city="+weatherId+"&key=c82d57ca44c0460f9b1538805aef8e5f";
            HttpUtil.sendOkhttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    Weather weather = Utility.handleWeatherResponse(resopnseText);
                    if (weather != null && "ok".equals(weather.status)){
                        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(AutoUpdateService.this).edit();
                        editor.putString("weather",resopnseText);
                        editor.apply();
                        Log.d("Update", "onResponse:111Weather");
                    }
                }
            });
        }
    ...
    private void updateBingPic(){
        ...
        HttpUtil.sendOkhttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                editor.apply();
                Log.d("Update", "onResponse:111bingyin");
            }
        });
    }
}
